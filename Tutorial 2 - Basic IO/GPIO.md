...
There seems to be a lot of different modes and pulls in the initialization, right? However, you actually only need to know 4 of them - `GPIO_MODE_INPUT`, `GPIO_MODE_OUTPUT_PP`, `GPIO_PULLUP`, `GPIO_PULLDOWN`.
